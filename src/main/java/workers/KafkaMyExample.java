...
public class KafkaMyExample {
    private final String topic;
    private final Properties props;

    public KafkaMyExample(String brokers, String username, String password) {
    ...
    public static void main(String[] args) {
        ...
        KafkaMyExample c = new KafkaMyExample(brokers, username, password);
        c.produce();
        c.consume();
    }
